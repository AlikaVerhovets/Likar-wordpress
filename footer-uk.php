...
<footer>
  <div class="footer-up">
    ...
    <div class="footer-up-left">
      <div class="footer-up-left-text">
        Понад 3000 оперативних втручань. Понад 2000 нехірургічних процедур, що омолоджують. Гарантія якості та краси.
      </div>
    </div>

    <div class="footer-up-containers">
      <h4 class="footer-h">Категорії</h4>
      <?php wp_nav_menu(array
      ( 'menu' => 'menu-footer-category-uk',
      'menu_class' => 'footer-text-p' 
      )
      ); ?>
    </div>
    <div class="footer-up-containers">
      <h4 class="footer-h"> Послуги</h4>
      <?php wp_nav_menu(array
      ( 'menu' => 'menu-footer-servises-uk',
      'menu_class' => 'footer-text-p' 
      )
      ); ?>
    </div>
  ...
  <div class="footer-down">
    <div class="footer-down-container">
      <div>
        Баранская 2020 © Всі права захищені
      </div>
