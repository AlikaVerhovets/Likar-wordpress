...
<body>
  ...
  <div class="header">
    <address class="header-adress">
      <img src="<?php bloginfo('template_directory') ?>/img/icons8-геозона-100 8.svg" alt="">
      м. Київ, вул.Зоологічна 3-В
    </address>
    <div class="header-mail">
      <img src="<?php bloginfo('template_directory') ?>/img/icons8-сообщение-с-заливкой-100 8.svg" alt="">
      <!-- <a href="mailto:olgabaranskaya@gmail.com"> -->
        olgabaranskaya@gmail.com
      <!-- </a> -->
    </div>
    <div class="header-phone">
      <img src="<?php bloginfo('template_directory') ?>/img/icons8-телефон-100 1.svg" alt="">
    ...
    <div class="header-price-button popup-open">
      <button type="button" class="header-price-button-body pointer">
        <span class="header-price-button-text">Дізнатися ціну</span>
      </button>
    </div>
  </div>
